...
- **Zoom Controls:** 1x–3x zoom for precise focal point alignment.
...
3. **Select Instagram Story preset:** Click the "Instagram" tab and choose "Story (1080x1920)". The crop overlay snaps to the correct aspect ratio.

4. **Adjust the crop:** Drag the image to reposition your product in the frame. Use the zoom slider (up to 3x) to fine-tune composition. Toggle the rule of thirds overlay if you want to align with compositional guidelines.
...
4. Manually enter 1080x1920 dimensions
5. Click "Resize"
...
### Test 1: Single 5MB JPG → Instagram Story (1080x1920)
