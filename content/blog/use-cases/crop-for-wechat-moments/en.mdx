...
![Setting square dimensions](https://example.com/set-square-dimensions-en.jpg)
...
![Dragging the crop box for secondary composition](https://example.com/secondary-composition-en.jpg)
*(This is a placeholder image link. You can replace it with an actual screenshot.)*
